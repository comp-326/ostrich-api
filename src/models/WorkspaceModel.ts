...
}&WorkspaceType&mongoose.Document

export type WorkspaceModelType = {
	[x:string]:any
}&mongoose.Model<WorkspaceDocumentType>

const WorkspaceSchema:mongoose.Schema<WorkspaceDocumentType> = new mongoose.Schema(
	{
		owner: {
...
const WorkspaceModel = mongoose.model<WorkspaceDocumentType,WorkspaceModelType>("Workspace", WorkspaceSchema)
