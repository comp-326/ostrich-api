...
const activateUserUseCase = makeEditActivateUserUseCase({ userDB: UserRepository })
const editPasswordUseCase = makeEditUserPasswordUseCase({ userDB: UserRepository })
const requestPasswordReset = makeRequestPasswordReset({ userDB: UserRepository })
const requestAccountActivation = makeRequestAccountActivation({ userDB: UserRepository })
